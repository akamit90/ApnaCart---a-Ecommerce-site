    ...
    
    {
      ...
      <div className="flex flex-col lg:flex-row shadow-md my-10">
          <div className="w-full lg:w-3/4 bg-white px-10 py-10">
    ...
    
            {
              cart.map((cartItem)=>(
                ...
                <div className='flex justify-center w-1/5'>
                  <button className='border px-1 py-1'onClick={()=>handleDec(cartItem.id)}>-</button>
                  <button className=' px-2 '>{cartItem.quantity}</button>
                  <button className='border px-1 py-1'onClick={()=>handleInc(cartItem.id)}>+</button>
                </div>
            ...
            <p  className="flex font-semibold text-indigo-600 text-sm mt-10 cursor-pointer" onClick={()=>navigate("/allproducts")}>
          ...
          <div id="summary" className=" w-full lg:w-1/4 px-8 py-10 bg-[#f6f6f6]">
            ...
            <div>
              ...
              <select className="block p-2 text-gray-600 w-full text-sm">
                <option>Standard shipping - 40Rs</option>
              </select>
            </div>
            <div className="py-10">
